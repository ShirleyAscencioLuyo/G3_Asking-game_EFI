    ...
    public void listar(DefaultTableModel modeloTabla, Integer tipo, String dato) throws Exception {
        ...
        switch (tipo) {
            case 1:
                ...
                break;
            case 2:
                sql = "select * from usuario where nomcli like '%" + dato + "%'";
                break;
            case 3:
                sql = "select * from usuario where apecli like '%" + dato + "%'";
                break;
            case 4:
                sql = "select * from usuario where dnicli like '%" + dato + "%'";
                break;
            case 5:
                sql = "select * from usuario where sexcli = '" + dato + "'";
                break;
        }
